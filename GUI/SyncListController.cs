...
namespace Syncoco.GUI
{
  ...
  {
    private FilesToSynchronizeCollector[] _collectors;
    private SyncList _view;
    private ListViewItemComparer _comparer = new ListViewItemComparer();
    ...
    private System.Drawing.Color GetBackColor(SyncAction action)
    {
      switch (action)
      {
    ...
    private class ListViewItemComparer : IComparer
    {
      ...
      private CompareFunction[] _comparers = new CompareFunction[3];
      private bool[] _reverse = new bool[3];
